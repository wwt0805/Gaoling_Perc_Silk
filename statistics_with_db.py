...
for status, count in status_dict.items():
    try:
        ...
        # 插入数据到数据库
        query = "INSERT INTO status_logs (status_code, status_description, count, total_time) VALUES (%s, %s, %s, %s)"
        values = (status, status_description, count, total_time)
